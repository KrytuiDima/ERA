// js/create.js — Створення нових постів

/**
 * Відкриває модальне вікно створення поста та скидає стан
 */
...
/**
 * Обробка вибраних файлів для поста
 */
function onPostFile(e) {
  const files = Array.from(e.target.files || []); if (!files.length) return;
  e.target.value = ''; // Скидаємо input, щоб можна було вибрати той самий файл знову
...
/**
 * Відображає сітку завантажених фото у модальному вікні
 */
...
/**
 * Публікація поста (Async для майбутнього Supabase)
 */
